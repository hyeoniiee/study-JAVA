...
public class SavingsAccount implements BankAccount, InterestBearing {
    ...
    double monthlyDeposit; // 적금

    // 생성자
    public SavingsAccount(String accountNumber, double balance, double interestRate, double monthlyDeposit) {
    ...
    public void displayAccountInfo() {
        ...
        System.out.println("적금금액 : " + monthlyDeposit + "원");
    }
